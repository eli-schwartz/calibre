...
from PyQt5.Qt import (
	QApplication, QFont, QHBoxLayout, QIcon, QMenu, QModelIndex,
	QStandardItem, QStandardItemModel, QStyledItemDelegate, Qt,
...
class TOC(QStandardItemModel):
    ...
    def next_entry(self, spine_pos, anchor_map, viewport_rect, in_paged_mode,
        ...
        if in_paged_mode:
            ...
            anchor_map = {k:v[0] for k, v in anchor_map.items()}
        else:
