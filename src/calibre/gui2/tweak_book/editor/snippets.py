...
from PyQt5.Qt import (
	QDialog, QDialogButtonBox, QFrame, QGridLayout, QHBoxLayout, QIcon,
	QLabel, QLineEdit, QListWidget, QListWidgetItem, QObject, QPlainTextEdit,
	QPushButton, QSize, QStackedLayout, Qt, QToolButton, QVBoxLayout, QWidget
)
