...
from PyQt5.Qt import (
	QApplication, QBrush, QCheckBox, QColor, QColorDialog, QComboBox, QFont, QFormLayout,
	QHBoxLayout, QIcon, QLabel, QLineEdit, QPalette, QPixmap, QPushButton, QScrollArea,
	QSize, QSplitter, Qt, QTextCharFormat, QToolButton, QVBoxLayout, QWidget, pyqtSignal
)
