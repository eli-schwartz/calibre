...
from PyQt5.Qt import (
	QApplication, QColor, QIcon, QLabel, QMenu, QPainter, QPalette, QRect, QScrollArea,
	QSize, QSizePolicy, QStackedLayout, Qt, QTimer, QUrl, QVBoxLayout, QWidget, pyqtSignal
)
