...
from calibre.constants import __appname__, get_version, isosx, preferred_encoding
...
from PyQt5.Qt import (
	QAction, QApplication, QFont, QIcon, QLabel, QMenu, QPainter,
	QSizePolicy, QSplitter, QStackedWidget, QStatusBar, QStyle,
	QStyleOption, Qt, QTabBar, QTimer, QToolButton, QVBoxLayout, QWidget
)
